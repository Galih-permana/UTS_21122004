...
<?php
echo '<table border="1">';
echo '<tr><th>Tingkat</th><th>Nama Sekolah</th></tr>';
echo '<tr><td>TK</td><td>TK AL-Barokah</td></tr>';
echo '<tr><td>SD</td><td>SDN Sanding 02</td></tr>';
echo '<tr><td>SMP</td><td>SMPN 02 Malangbong</td></tr>';
echo '<tr><td>SMA</td><td>AL-Barokah</td></tr>';
echo '</table>';
?>
<head>
    <style>
